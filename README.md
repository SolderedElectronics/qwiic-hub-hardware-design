# qwiic Hub Hardware Design

## About the Product

| ![qwiic Hub Image](https://solde.red/333018/image) |
| :----------------------------------------------------------: |
| [Buy qwiic Hub](https://www.solde.red/333018) |

We made the qwiic system for faster prototyping and easy connection between the components. However, some of the components have only one qwiic port or you just want your cable managmenet made better. What to do in those cases? The qwiic hub comes to the rescue! It has six connectors so you can easily expand your circuit. It’s as simple of a device as it can get.

---

## Repository Contents

This repository contains all design files for qwiic Hub, organized as follows:
